...
const goals = [
  ...
  },
  {
    ...
    desc: "Dalla rivoluzione industriale il consumo di risorse naturali, la produzione di rifiuti e le emissioni di gas serra sono cresciuti senza sosta. Dissociare la crescita economica dall'uso intensivo di risorse e contrastare i rischi climatici è la sfida più importante della società contemporanea: serve una radicale inversione di rotta, con politiche orientate alla sostenibilità a tutti i livelli — produzione, commercializzazione e consumo.",
    icon: ThermometerSun,
